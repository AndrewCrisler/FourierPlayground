...
public class WavFile {
    ...
    public WavFile(String filename) {
        ...
        System.out.println(chunkSize + " - chunksize(in test)");
    ...
    public WavFile(String filename, int numChannels, long numFrames, int validBits,
        ...
        try {
            ...
            long dataChunkSize = blockAlign * (numFrames / numChannels); //divided by numChannels by user to hopfully fix the dual channal problem
            ...
            System.out.println(mainChunkSize + " - main chunk size"); //added by user
    ...
    public long getNumFrames() {
        return numFrames * numChannels; //changed by user (this seems to fix the wrong frames being returned when the number of channels is not  1)
    }
